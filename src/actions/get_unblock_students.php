<?php
    ...
    try {
        ...
        if(isset($_GET['searchKey'])){
            ...
            $sql = "SELECT * FROM student WHERE status=1 AND is_black_list != 1 AND (first_name LIKE '%$key%' OR last_name LIKE '%$key%' OR stu_id LIKE '$key%') ORDER BY stu_id DESC";
        } else {
            ...
            $sql = "SELECT * FROM student WHERE status=1 AND is_black_list != 1 ";
